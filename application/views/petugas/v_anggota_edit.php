    ...
    <div class="card-body">
      ...
      <form method="post" action="<?php echo base_url().'petugas/anggota_update' ?>">
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="nama" placeholder="Masukan nama lengkap" required="required" value="<?php echo$a->nama; ?>">
        </div>
        <div class="form-group">
          <label class="font-weight-bold" for="nik">Nik</label>
          <input type="number" class="form-control" name="nik" placeholder="Masukan nik" required="required" value="<?php echo$a->nik; ?>">
        </div>
        <div class="form-group">
          <label class="font-weight-bold" for="alamat">Alamat</label>
          <textarea class="form-control" name="alamat" required="required" placeholder="Masukan alamat"><?php echo$a->alamat; ?> </textarea>
        </div>
